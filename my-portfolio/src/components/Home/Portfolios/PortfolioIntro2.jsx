...
    setTargetY(prevY => {
      // Calcular el índice del piso actual aproximado basado en la posición Y del ascensor
      const currentFloorBaseY = prevY - (ELEVATOR_HEIGHT / 2);
      // Calcula el índice del piso redondeando a la planta más cercana
      let currentFloorIndex = Math.round((currentFloorBaseY - (-BUILDING_HEIGHT / 2)) / FLOOR_HEIGHT);
...
    >
      <Canvas className="canvas" camera={{ position: [0, 0, -25], fov: 75 }} shadows>
        {/* Luces */}
